...
# HH-RLHF Dataset
With the full name as `Helpful and Harmless - Reinforcement Learning from Human Feedback`, this dataset aims to adjust the model ability to provide more helpful and harmless responses.
