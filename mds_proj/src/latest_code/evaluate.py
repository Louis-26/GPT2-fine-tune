...
from fastchat.llm_judge.common import chat_completion_openai
...
class ChatGPTEvaluator:
    ...
    def _get_rating(self, question, answer, temperature=0, max_tokens=2048):
        ...
        response = chat_completion_openai(self.response_model, conv, temperature=temperature, max_tokens=max_tokens)
